 ...
 * @author Davy Sheehy
 */
public class WalesGUI extends javax.swing.JFrame {

    /**
     * Creates new form WalesGUI
     */
    public WalesGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        titleLbl.setText("Wales Team Home");
        ...
        coachNameLbl.setText("Warren Gatland");
        ...
        capNameLbl.setText("Alun Wyn Jones");
        backgroundPanel.add(capNameLbl);
        capNameLbl.setBounds(140, 100, 150, 22);

        stadiumNameLbl.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        stadiumNameLbl.setForeground(new java.awt.Color(255, 255, 255));
        stadiumNameLbl.setText("Principality Stadium");
        backgroundPanel.add(stadiumNameLbl);
        stadiumNameLbl.setBounds(140, 130, 190, 22);

        logoBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Welsh_Rugby_Union_logo.jpg"))); // NOI18N
        ...
        logoBtn.setBounds(420, 50, 200, 260);

        romeTouristInfoBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        coachinfoBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        capInfoBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        dubTouristBtn1.setBackground(new java.awt.Color(255, 0, 51));
        ...
        cardiffTouristBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        parisTouristBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        londonTouristInfoBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        edinTouristInfoBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        matchInfoBtn.setBackground(new java.awt.Color(255, 0, 51));
        ...
        matchInfoBtn.setBounds(30, 310, 270, 70);
    ...
    private void coachinfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_coachinfoBtnActionPerformed
        // TODO add your handling code here:
        Manager headcoach = new Manager(44, 47, 2, 54, "New Zealand", "Warren Gatland");
    ...
    private void capInfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_capInfoBtnActionPerformed
        // TODO add your handling code here:
        Captain cap = new Captain("Alun Wyn Jones",32,"Wales", 113, "Ospreys");
    ...
    private void matchInfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matchInfoBtnActionPerformed
        ...
        MatchDay walGame1 = new MatchDay("Italy", "Wales", "JP Doyle", "Stadio Olympico, Rome", "3:00pm", "5/02/2017");
        matchArr.add(walGame1);
        MatchDay walGame2 = new MatchDay("Wales", "England", "Jerome Garces", "Principality Stadium, Cardiff", "4:50pm", "11/02/2017");
        matchArr.add(walGame2);
        MatchDay walGame3 = new MatchDay("Scotland", "Wales", "John Lacey", "Murrayfield, Edinburgh", "2:25pm", "25/02/2017");
        matchArr.add(walGame3);
        MatchDay walGame4 = new MatchDay("Wales", "Ireland", "Wayne Barnes", "Principality Stadium, Cardiff", "8:05pm", "10/03/2017");
        matchArr.add(walGame4);
        MatchDay walGame5 = new MatchDay("France", "Wales", "Wayne Barnes", "Stade de France, Paris", "3:45pm", "18/03/2017");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WalesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
