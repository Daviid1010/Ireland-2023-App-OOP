 ...
 * @author Davy Sheehy
 */
public class ScotlandGUI extends javax.swing.JFrame {

    /**
     * Creates new form ScotlandGUI
     */
    public ScotlandGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        titleLbl.setText("Scotland Team Home");
        ...
        stadiumNameLbl.setText("Murrayfield");
        backgroundPanel.add(stadiumNameLbl);
        stadiumNameLbl.setBounds(140, 130, 160, 22);

        logoBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Scottish_rugby_logo.jpg"))); // NOI18N
        ...
        logoBtn.setBounds(350, 30, 300, 330);

        romeTouristInfoBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        coachinfoBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        capInfoBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        dubTouristBtn1.setBackground(new java.awt.Color(1, 73, 132));
        ...
        cardiffTouristBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        parisTouristBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        londonTouristInfoBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        edinTouristInfoBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        logoutBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        matchinfoBtn.setBackground(new java.awt.Color(1, 73, 132));
        ...
        matchinfoBtn.setBounds(30, 300, 270, 70);
    ...
    private void coachinfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_coachinfoBtnActionPerformed
        // TODO add your handling code here:
        Manager headcoach = new Manager(4, 2, 0, 44, "Scotland", "Gregor Townsend");
    ...
    private void capInfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_capInfoBtnActionPerformed
        // TODO add your handling code here:
        Captain cap = new Captain("John Barclay",31,"Scotland", 65, "Scarlets");
    ...
    private void matchinfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matchinfoBtnActionPerformed
        ...
        MatchDay scotGame1 = new MatchDay("Scotland","Ireland","Romain Poite","MurrayField, Edinburgh","2:25pm","4/02/2017");
            matchArr.add(scotGame1);
            MatchDay scotGame2 = new MatchDay("France","Scotland","Jaco Peyper","Stade de France, Paris","16:00pm","12/02/2017");
            matchArr.add(scotGame2);
            MatchDay scotGame3 = new MatchDay("Scotland","Wales","John Lacey","MurrayField, Edinburgh","2:25pm","25/02/2017");
            matchArr.add(scotGame3);
            MatchDay scotGame4 = new MatchDay("England","Scotland","Mathieu Raynal","Twickenham, England","4:00pm","11/03/2017");
            matchArr.add(scotGame4);
            MatchDay scotGame5 = new MatchDay("Scotland","Italy","Pascal Gauzere","Murrayfield, Edinburgh","5:00pm","18/03/2017");
            matchArr.add(scotGame5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScotlandGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScotlandGUI().setVisible(true);
            }
        });
    }
